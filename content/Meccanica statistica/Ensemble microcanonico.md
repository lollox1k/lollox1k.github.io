...
L'upper bound uniforme e la quasi convessità implicano che al funzione limite $s(\rho,e)$ sarà convessa e limitata nella regione interna di $A$, quindi continua.
